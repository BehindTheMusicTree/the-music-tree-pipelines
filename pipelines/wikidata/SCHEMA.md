...
| [`3_regional_classification`](#3_regional_classification)                   | `2_regional_overview_classification.parquet`, Bronze `wikidata_genre_indigenous_to.parquet` | `3_regional_classification.parquet`                                          | `is_regional`, `regional_reason`    | ~53% of items flagged `is_regional` — 299 seed, 179 indigenous_to, ~1,524 direct, ~1,600 inherited (exploration-phase finding, see callout below)                                      |
