...
- **Silver:** five sequential steps refine Bronze into canonical and regional genre hierarchies:
...
`3_regional_classification.parquet`, `4_genre_parents.parquet`, `5_hierarchy.parquet`, and `5_regional_hierarchy.parquet`
