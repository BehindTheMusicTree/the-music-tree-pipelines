...
from wikidata.silver.hierarchy import MANUAL_TECHNIQUE_GENRES_PATH, MANUAL_THEME_GENRES_PATH, prune_genre_hierarchy
...
hierarchy_path, _ = prune_genre_hierarchy(
    genre_parents_path, MANUAL_THEME_GENRES_PATH, MANUAL_TECHNIQUE_GENRES_PATH, silver_dir
)
