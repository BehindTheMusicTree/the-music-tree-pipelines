...
import wikidata
from wikidata.silver.genre_classification import classify_regional_from_overviews
...
genre_classification_path = classify_regional_from_overviews(bronze_dir / "wikidata_genre_tree.parquet", silver_dir)
regional_classification_path = classify_regional_genres(genre_classification_path, silver_dir)
