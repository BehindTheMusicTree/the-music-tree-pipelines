...
import wikidata
from wikidata.silver.genre_classification import classify_genre_tree
...
genre_classification_path = classify_genre_tree(bronze_dir / "wikidata_genre_tree.parquet", silver_dir)
