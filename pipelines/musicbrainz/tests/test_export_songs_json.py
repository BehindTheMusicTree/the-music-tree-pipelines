...
_SCRIPT_PATH = Path(__file__).parent.parent / "scripts" / "export_songs_json.py"
_spec = importlib.util.spec_from_file_location("export_songs_json", _SCRIPT_PATH)
assert _spec is not None and _spec.loader is not None
export_songs_json_module = importlib.util.module_from_spec(_spec)
_spec.loader.exec_module(export_songs_json_module)
